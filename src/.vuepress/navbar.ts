    ...
    children: [
      {
        ...
        prefix: "",
        children: [
          { text: "C/C++ 语言与程序设计", icon: "microchip", link: "C-Cpp-语言与程序设计/01-intro.md" },
          ...
          { text: "Minecraft Paper 服务器插件开发", icon: "screwdriver-wrench", link: "Minecraft-Paper-服务器插件开发/intro.md" },
